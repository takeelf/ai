...
model = torch.load('realestate/realestate_model.pth')
scaler_x = joblib.load('realestate/realestate_scaler_x.pkl')
scaler_y = joblib.load('realestate/realestate_scaler_y.pkl')
location_encoder = joblib.load('realestate/realestate_label_encoder.pkl')
